<div class="">
    <div class="grid grid-cols-4">
        <div class="detail col-span-2">
            ...
            Username : <input type="text" class="input input-bordered w-full max-w-xs" value="{{$a['username']}}" id="usUpdate"/><br>
            Password : <input type="text" class="input input-bordered w-full max-w-xs" value="{{$a['password']}}" id="psUpdate"/><br>
            <div class="my-2">
